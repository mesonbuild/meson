...
def add_arguments(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument(
        "--config", help="The path to a valid project config file (toml)."
    )
    parser.add_argument(
        "--toolchain", help="The path to a valid toolchain config file (toml)."
    )
    parser.add_argument(
        "--dependencies", help="The path to a valid dependencies file (toml)."
    )
    parser.add_argument(
