...
builtin_options = OrderedDict([
    # Directories
    ('prefix',     BuiltinOption(UserPathOption, 'Installation prefix', default_prefix())),
    ('bindir',     BuiltinOption(UserPathOption, 'Executable directory', 'bin')),
    ('datadir',    BuiltinOption(UserPathOption, 'Data file directory', 'share')),
    ('includedir', BuiltinOption(UserPathOption, 'Header file directory', 'include')),
    ('infodir',    BuiltinOption(UserPathOption, 'Info page directory', 'share/info')),
    ('libdir',     BuiltinOption(UserPathOption, 'Library directory', default_libdir())),
    ('libexecdir', BuiltinOption(UserPathOption, 'Library executable directory', default_libexecdir())),
    ('localedir',  BuiltinOption(UserPathOption, 'Locale data directory', 'share/locale')),
    ('localstatedir',   BuiltinOption(UserPathOption, 'Localstate data directory', 'var')),
    ('mandir',          BuiltinOption(UserPathOption, 'Manual page directory', 'share/man')),
    ('sbindir',         BuiltinOption(UserPathOption, 'System executable directory', 'sbin')),
    ('sharedstatedir',  BuiltinOption(UserPathOption, 'Architecture-independent data directory', 'com')),
    ('sysconfdir',      BuiltinOption(UserPathOption, 'Sysconf data directory', 'etc')),
    # Core options
