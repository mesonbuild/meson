...
class File:
    def __init__(self, is_built: bool, subdir: str, fname: str):
        if fname.endswith(".C") or fname.endswith(".H"):
            mlog.warning("""You are using .C or .H files in your project. This is deprecated.
         ...
         See https://github.com/mesonbuild/meson/pull/8239 for the discussions.""", once=True)
