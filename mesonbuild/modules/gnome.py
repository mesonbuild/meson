...
if T.TYPE_CHECKING:
    ...
    from ..programs import AnyProgram, CommandList, CommandListEntry, ExternalProgram
...
class GnomeModule(ExtensionModule):
    ...
    def __init__(self, interpreter: 'Interpreter') -> None:
        ...
        self.giscanner: T.Optional[AnyProgram] = None
        self.gicompiler: T.Optional[AnyProgram] = None
    ...
    @staticmethod
    def _find_tool(state: 'ModuleState', tool: str) -> 'AnyProgram':
        tool_map = {
    ...
    def compile_resources(self, state: 'ModuleState', args: T.Tuple[str, 'FileOrString'],
        ...
        target_cmd: T.List[T.Union['AnyProgram', str]]
        if not mesonlib.version_compare(glib_version, gresource_dep_needed_version):
    ...
    def _get_gir_dep(self, state: 'ModuleState') -> T.Tuple[Dependency, AnyProgram, AnyProgram]:
        if not self.gir_dep:
    ...
    def _make_gir_target(
            ...
            state: 'ModuleState',
            girfile: str,
            scan_command: T.Sequence[T.Union['FileOrString', Executable, AnyProgram]],
    ...
    def compile_schemas(self, state: 'ModuleState', args: T.List['TYPE_var'], kwargs: 'CompileSchemas') -> ModuleReturnValue:
        ...
        cmd: T.List[T.Union['AnyProgram', str]] = [self._find_tool(state, 'glib-compile-schemas'), '--targetdir', outdir, srcdir]
        if state.subdir == '':
    ...
    def gdbus_codegen(self, state: 'ModuleState', args: T.Tuple[str, T.Optional[T.Union['FileOrString', build.GeneratedTypes]]],
        ...
        cmd: T.List[T.Union['AnyProgram', str]] = [self._find_tool(state, 'gdbus-codegen')]
    ...
    def _make_mkenum_impl(
        ...
        real_cmd: T.List[T.Union[str, 'AnyProgram']] = [self._find_tool(state, 'glib-mkenums')]
        real_cmd.extend(cmd)
    ...
    def genmarshal(self, state: 'ModuleState', args: T.Tuple[str], kwargs: 'GenMarshal') -> ModuleReturnValue:
        ...
        cmd: T.List[T.Union['AnyProgram', str]] = [self._find_tool(state, 'glib-genmarshal'), '--quiet']
        if kwargs['prefix']:
