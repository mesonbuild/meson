...
class GnomeModule(ExtensionModule):
    ...
    def __init__(self, interpreter: 'Interpreter') -> None:
        ...
        self.giscanner: T.Optional[ProgramType] = None
        self.gicompiler: T.Optional[ProgramType] = None
    ...
    @staticmethod
    def _find_tool(state: 'ModuleState', tool: str) -> ProgramType:
        tool_map = {
    ...
    def compile_resources(self, state: 'ModuleState', args: T.Tuple[str, 'FileOrString'],
        ...
        cmd: T.List[T.Union[ProgramType, str]] = [glib_compile_resources, '@INPUT@']
        ...
        target_cmd: T.List[T.Union[ProgramType, str]]
        if not mesonlib.version_compare(glib_version, gresource_dep_needed_version):
    ...
    def _get_gir_dep(self, state: 'ModuleState') -> T.Tuple[Dependency, ProgramType, ProgramType]:
        if not self.gir_dep:
    ...
    def _gir_has_option(self, option: str) -> bool:
        exe = self.giscanner
        if isinstance(exe, (Executable, OverrideProgram, CustomTargetIndex)):
    ...
    def _make_gir_target(
            ...
            state: 'ModuleState',
            girfile: str,
            scan_command: T.Sequence[T.Union['FileOrString', Executable, ProgramType]],
    ...
    def _make_typelib_target(state: 'ModuleState', typelib_output: str,
                             typelib_cmd: T.Sequence[T.Union[str, Executable, CustomTarget, ProgramType]],
                             generated_files: T.Sequence[T.Union[str, mesonlib.File, CustomTarget, CustomTargetIndex, GeneratedList]],
    ...
    def generate_gir(self, state: 'ModuleState', args: T.Tuple[T.List[T.Union[Executable, build.SharedLibrary, build.StaticLibrary]]],
        ...
        scan_command: T.List[T.Union[str, Executable, ProgramType]] = [giscanner]
        scan_command += ['--quiet']
    ...
    def compile_schemas(self, state: 'ModuleState', args: T.List['TYPE_var'], kwargs: 'CompileSchemas') -> ModuleReturnValue:
        ...
        cmd: T.List[T.Union[ProgramType, str]] = [self._find_tool(state, 'glib-compile-schemas'), '--targetdir', outdir, srcdir]
        if state.subdir == '':
    ...
    def yelp(self, state: 'ModuleState', args: T.Tuple[str, T.List[str]], kwargs: 'Yelp') -> ModuleReturnValue:
        ...
        pot_args: T.List[T.Union[ProgramType, str]] = [itstool, '-o', pot_file]
        ...
        for l in langs:
            ...
            po_file = l + '.po'
            po_args: T.List[T.Union[ProgramType, str]] = [
                msgmerge, '-q', '-o',
    ...
    def gdbus_codegen(self, state: 'ModuleState', args: T.Tuple[str, T.Optional[T.Union['FileOrString', build.GeneratedTypes]]],
        ...
        cmd: T.List[T.Union[ProgramType, str]] = [self._find_tool(state, 'gdbus-codegen')]
    ...
    def _make_mkenum_impl(
        ...
        real_cmd: T.List[T.Union[str, ProgramType]] = [self._find_tool(state, 'glib-mkenums')]
        real_cmd.extend(cmd)
    ...
    def genmarshal(self, state: 'ModuleState', args: T.Tuple[str], kwargs: 'GenMarshal') -> ModuleReturnValue:
        ...
        cmd: T.List[T.Union[ProgramType, str]] = [self._find_tool(state, 'glib-genmarshal'), '--quiet']
        if kwargs['prefix']:
    ...
    def generate_vapi(self, state: 'ModuleState', args: T.Tuple[str], kwargs: 'GenerateVapi') -> ModuleReturnValue:
        ...
        cmd: T.List[T.Union[ProgramType, str]]
