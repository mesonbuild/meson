...
class GnomeModule(ExtensionModule):
    ...
    def compile_resources(self, state: 'ModuleState', args: T.Tuple[str, 'FileOrString'],
        ...
        install_dir = kwargs['install_dir'] or state.environment.coredata.optstore.get_value_for_safe(OptionKey('includedir'), str)
    ...
    def _make_mkenum_impl(
        ...
        real_cmd.extend(cmd)
        _install_dir = install_dir or state.environment.coredata.optstore.get_value_for_safe(OptionKey('includedir'), str)
    ...
    def generate_vapi(self, state: 'ModuleState', args: T.Tuple[str], kwargs: 'GenerateVapi') -> ModuleReturnValue:
        ...
        datadir = state.environment.coredata.optstore.get_value_for_safe(OptionKey('datadir'), str)
