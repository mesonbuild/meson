...
class GnomeModule(ExtensionModule):
    ...
    def compile_resources(self, state: 'ModuleState', args: T.Tuple[str, 'FileOrString'],
        ...
        install_dir = kwargs['install_dir'] or state.environment.coredata.get_option(OptionKey.factory('includedir'))
    ...
    def _get_langs_compilers_flags(state: 'ModuleState', langs_compilers: T.List[T.Tuple[str, 'Compiler']]
        ...
        for lang, compiler in langs_compilers:
            ...
            if OptionKey.factory('b_sanitize') in compiler.base_options:
    ...
    def _make_mkenum_impl(
        ...
        real_cmd.extend(cmd)
        _install_dir = install_dir or state.environment.coredata.get_option(OptionKey.factory('includedir'))
    ...
    def generate_vapi(self, state: 'ModuleState', args: T.Tuple[str], kwargs: 'GenerateVapi') -> ModuleReturnValue:
        ...
        datadir = state.environment.coredata.get_option(OptionKey.factory('datadir'))
