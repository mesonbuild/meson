...
_DRIVER_TABLE_VERSION: T.List[_CudaVersion] = [
    _CudaVersion('12.0.1', '528.41', '525.60.13'),
    ...
    _CudaVersion('11.6.1', '511.65', '510.47.03'),
    _CudaVersion('11.6.0', '511.23', '510.39.01'),
    _CudaVersion('11.5.1', '496.13', '495.29.05'),
    _CudaVersion('11.5.0', '496.04', '495.29.05'),
    _CudaVersion('11.4.3', '472.50', '470.82.01'),
    _CudaVersion('11.4.1', '471.41', '470.57.02'),
    _CudaVersion('11.4.0', '471.11', '470.42.01'),
    _CudaVersion('11.3.0', '465.89', '465.19.01'),
    ...
    _CudaVersion('11.0.3', '451.82', '450.51.06'),
    ...
    _CudaVersion('148', '398.26', '396.37'),
