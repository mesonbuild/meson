...
class DictHolder(ObjectHolder[dict[str, TYPE_var]], IterableObject):
    ...
    def values_method(self, args: list[TYPE_var], kwargs: TYPE_kwargs) -> list[TYPE_var]:
    ...
    def get_method(self, args: tuple[str, TYPE_var | None], kwargs: TYPE_kwargs) -> TYPE_var:
