...
TEST_KWS: T.List[KwargInfo] = [
    ...
    KwargInfo('should_fail', (bool, NoneType), deprecated='1.8.0', deprecated_message='Use expected_fail instead of should_fail'),
    KwargInfo('expected_fail', (bool, NoneType), since='1.8.0'),
    KwargInfo('expected_exitcode', (int, NoneType), since='1.8.0'),
