...
class DependencyFallbacksHolder(MesonInterpreterObject):
    ...
    def lookup(self, kwargs: TYPE_nkwargs, force_fallback: bool = False) -> Dependency:
        ...
        wrap_mode = WrapMode.from_string(self.coredata.optstore.get_value_for_safe(OptionKey('wrap_mode'), str))
        force_fallback_for = self.coredata.optstore.get_value_for_safe(OptionKey('force_fallback_for'), list)
