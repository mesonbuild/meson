...
class MesonMain(MesonInterpreterObject):
    ...
    def get_compiler_method(self, args: T.Tuple[str], kwargs: 'NativeKW') -> 'Compiler':
        ...
        try:
            ...
            FeatureBroken.single_use('using `meson.get_compiler()` for languages only initialized in another subproject', '1.10.0', self.subproject,
                                     'This is extremely fragile, as your project likely cannot be used except as a subproject in specific cases.')
            return comp
