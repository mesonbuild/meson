...
class CompilerHolder(ObjectHolder['Compiler']):
    ...
    def _determine_args(self, kwargs: BaseCompileKW,
        ...
        args: T.List[str] = []
        for i in self.interpreter.extract_incdirs(kwargs, feature_new_version='1.10.0'):
    ...
    def find_library_method(self, args: T.Tuple[str], kwargs: 'FindLibraryKW') -> 'dependencies.ExternalLibrary':
        ...
        include_directories = self.interpreter.extract_incdirs(kwargs, key='header_include_directories', feature_new_version='1.10.0')
    ...
    def preprocess_method(self, args: T.Tuple[T.List['mesonlib.FileOrString']], kwargs: 'PreprocessKW') -> T.List[build.CustomTargetIndex]:
        ...
        tg = build.CompileTarget(
            ...
            kwargs['compile_args'],
            self.interpreter.extract_incdirs(kwargs, feature_new_version='1.10.0'),
            kwargs['dependencies'],
            kwargs['depends'])
