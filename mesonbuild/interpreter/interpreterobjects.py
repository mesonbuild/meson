...
_ERROR_MSG_KW: KwargInfo[str | None] = KwargInfo('error_message', (str, NoneType))
...
def extract_search_dirs(kwargs: kwargs.ExtractSearchDirs) -> list[str]:
...
class FeatureOptionHolder(ObjectHolder[Feature]):
    ...
    def enabled_method(self, args: list[TYPE_var], kwargs: TYPE_kwargs) -> bool:
        return self.held_object.is_enabled()

    @noPosargs
    @noKwargs
    @InterpreterObject.method('disabled')
    def disabled_method(self, args: list[TYPE_var], kwargs: TYPE_kwargs) -> bool:
    ...
    def allowed_method(self, args: list[TYPE_var], kwargs: TYPE_kwargs) -> bool:
        return not self.held_object.is_disabled()

    @noPosargs
    @noKwargs
    @InterpreterObject.method('auto')
    def auto_method(self, args: list[TYPE_var], kwargs: TYPE_kwargs) -> bool:
        return self.held_object.is_auto()

    def _disable_if(self, condition: bool, message: str | None) -> Feature:
        if not condition:
    ...
    def require_method(self, args: tuple[bool], kwargs: kwargs.FeatureOptionRequire) -> Feature:
    ...
    def disable_if_method(self, args: tuple[bool], kwargs: kwargs.FeatureOptionRequire) -> Feature:
    ...
    def enable_if_method(self, args: tuple[bool], kwargs: kwargs.FeatureOptionRequire) -> Feature:
        if not args[0]:
            return self.held_object
    ...
    def disable_auto_if_method(self, args: tuple[bool], kwargs: TYPE_kwargs) -> Feature:
    ...
    def enable_auto_if_method(self, args: tuple[bool], kwargs: TYPE_kwargs) -> Feature:
...
class RunProcess(MesonInterpreterObject):
    ...
    def run_command(self,
        ...
        def proc_output_thread(pipe: T.IO, capture_list: list, io_obj: T.TextIO) -> None:
            while True:
                line = pipe.readline()
                if not line:
                    break
        ...
        stdin: T.TextIO | int = sys.stdin if self.console else subprocess.DEVNULL
    ...
    def returncode_method(self, args: list[TYPE_var], kwargs: TYPE_kwargs) -> int:
        return self.returncode

    @noPosargs
    @noKwargs
    @InterpreterObject.method('stdout')
    def stdout_method(self, args: list[TYPE_var], kwargs: TYPE_kwargs) -> str:
        return self.stdout

    @noPosargs
    @noKwargs
    @InterpreterObject.method('stderr')
    def stderr_method(self, args: list[TYPE_var], kwargs: TYPE_kwargs) -> str:
        return self.stderr
...
class EnvironmentVariablesHolder(ObjectHolder[mesonlib.EnvironmentVariables], MutableInterpreterObject):
    ...
    def __deepcopy__(self, memo: dict[str, object]) -> EnvironmentVariablesHolder:
    ...
    def set_method(self, args: tuple[str, list[str]], kwargs: EnvironmentSeparatorKW) -> None:
        name, values = args
    ...
    def unset_method(self, args: tuple[str], kwargs: TYPE_kwargs) -> None:
        self.held_object.unset(args[0])

    @typed_pos_args('environment.append', str, varargs=str, min_varargs=1)
    @typed_kwargs('environment.append', ENV_SEPARATOR_KW)
    @InterpreterObject.method('append')
    def append_method(self, args: tuple[str, list[str]], kwargs: EnvironmentSeparatorKW) -> None:
        name, values = args
    ...
    def prepend_method(self, args: tuple[str, list[str]], kwargs: EnvironmentSeparatorKW) -> None:
        name, values = args
        self.warn_if_has_name(name)
        self.held_object.prepend(name, values, kwargs['separator'])


_CONF_DATA_SET_KWS: KwargInfo[str | None] = KwargInfo('description', (str, NoneType))
...
class ConfigurationDataHolder(ObjectHolder[build.ConfigurationData], MutableInterpreterObject):
    ...
    def __deepcopy__(self, memo: dict) -> ConfigurationDataHolder:
    ...
    @InterpreterObject.method('set')
    def set_method(self, args: tuple[str, str | int | bool], kwargs: kwargs.ConfigurationDataSet) -> None:
        self.__check_used()
    ...
    def set_quoted_method(self, args: tuple[str, str], kwargs: kwargs.ConfigurationDataSet) -> None:
        self.__check_used()
    ...
    def set10_method(self, args: tuple[str, int | bool], kwargs: kwargs.ConfigurationDataSet) -> None:
        self.__check_used()
    ...
    def has_method(self, args: tuple[str | int | bool], kwargs: TYPE_kwargs) -> bool:
    ...
    def get_method(self, args: tuple[str, str | int | bool | None],
                   kwargs: TYPE_kwargs) -> str | int | bool:
        name = args[0]
    ...
    def get_unquoted_method(self, args: tuple[str, str | int | bool | None],
                            kwargs: TYPE_kwargs) -> str | int | bool:
        name = args[0]
        if name in self.held_object:
    ...
    def get(self, name: str) -> tuple[str | int | bool, str | None]:
    ...
    def keys_method(self, args: list[TYPE_var], kwargs: TYPE_kwargs) -> list[str]:
    ...
    def merge_from_method(self, args: tuple[build.ConfigurationData], kwargs: TYPE_kwargs) -> None:
        from_object = args[0]
...
class DependencyHolder(ObjectHolder[Dependency]):
    ...
    def type_name_method(self, args: list[TYPE_var], kwargs: TYPE_kwargs) -> str:
    ...
    def version_method(self, args: list[TYPE_var], kwargs: TYPE_kwargs) -> str:
        return self.held_object.get_version()

    @noPosargs
    @noKwargs
    @InterpreterObject.method('name')
    def name_method(self, args: list[TYPE_var], kwargs: TYPE_kwargs) -> str:
    ...
    def configtool_method(self, args: tuple[str], kwargs: TYPE_kwargs) -> str:
    ...
    def variable_method(self, args: tuple[str | None], kwargs: kwargs.DependencyGetVariable) -> str:
    ...
    def include_type_method(self, args: list[TYPE_var], kwargs: TYPE_kwargs) -> str:
    ...
    def as_system_method(self, args: tuple[str | None], kwargs: TYPE_kwargs) -> Dependency:
    ...
    def as_static_method(self, args: list[TYPE_var], kwargs: InternalDependencyAsKW) -> Dependency:
        if not isinstance(self.held_object, InternalDependency):
    ...
    def as_shared_method(self, args: list[TYPE_var], kwargs: InternalDependencyAsKW) -> Dependency:
        if not isinstance(self.held_object, InternalDependency):
...
class ProgramHolder(ObjectHolder[_PROG]):
    ...
    def path_method(self, args: list[TYPE_var], kwargs: TYPE_kwargs) -> str:
    ...
    def full_path_method(self, args: list[TYPE_var], kwargs: TYPE_kwargs) -> str:
        return self._full_path()
    ...
    def cmd_array_method(self, args: list[TYPE_var], kwargs: TYPE_kwargs) -> list[str]:
        if not self.found():
            raise InterpreterException('Unable to get the path of a not-found external program')
        if not self.held_object.runnable():
            return [self._full_path()]
...
class MachineHolder(ObjectHolder['MachineInfo']):
    ...
    def cpu_family_method(self, args: list[TYPE_var], kwargs: TYPE_kwargs) -> str:
        return self.held_object.cpu_family

    @noPosargs
    @noKwargs
    @InterpreterObject.method('cpu')
    def cpu_method(self, args: list[TYPE_var], kwargs: TYPE_kwargs) -> str:
        return self.held_object.cpu

    @noPosargs
    @noKwargs
    @InterpreterObject.method('system')
    def system_method(self, args: list[TYPE_var], kwargs: TYPE_kwargs) -> str:
        return self.held_object.system

    @noPosargs
    @noKwargs
    @InterpreterObject.method('endian')
    def endian_method(self, args: list[TYPE_var], kwargs: TYPE_kwargs) -> str:
        return self.held_object.endian

    @noPosargs
    @noKwargs
    @InterpreterObject.method('kernel')
    def kernel_method(self, args: list[TYPE_var], kwargs: TYPE_kwargs) -> str:
    ...
    def subsystem_method(self, args: list[TYPE_var], kwargs: TYPE_kwargs) -> str:
...
class IncludeDirsHolder(ObjectHolder[build.IncludeDirs]):
    ...
    def to_list_method(self, args: list[TYPE_var], kwargs: TYPE_kwargs) -> list[str]:
...
class Test(MesonInterpreterObject):
    def __init__(self, name: str, project: str, suite: list[str],
                 exe: Program | build.Executable | build.CustomTarget | build.CustomTargetIndex | build.Jar,
                 depends: T.Sequence[kwargs.TargetDepends],
                 is_parallel: bool,
                 cmd_args: list[build.CommandTypes],
                 env: mesonlib.EnvironmentVariables,
                 expected_fail: bool, expected_exitcode: int, timeout: int, workdir: str | None, protocol: str,
        ...
        self.depends: list[build.BuildTargetTypes] = []
        for d in depends:
    ...
    def get_exe(self) -> Program | build.Executable | build.Jar | build.CustomTarget | build.CustomTargetIndex:
        return self.exe
...
class Doctest(Test):
    target: build.BuildTarget | None = None
...
class SubprojectHolder(MesonInterpreterObject):
    ...
    def __init__(self, subinterpreter: Interpreter | NullSubprojectInterpreter,
                 subdir: str,
                 warnings: int = 0,
                 disabled_feature: str | None = None,
                 exception: Exception | None = None,
                 callstack: list[tuple[str, MachineChoice]] | None = None) -> None:
        super().__init__()
        ...
        self.cm_interpreter: CMakeInterpreter | None = None
    ...
    @unholder_return
    def get_variable(self, args: tuple[str, str | None], kwargs: TYPE_kwargs) -> TYPE_var | InterpreterObject:
    ...
    @noArgsFlattening
    @InterpreterObject.method('get_variable')
    def get_variable_method(self, args: tuple[str, str | None], kwargs: TYPE_kwargs) -> TYPE_var | InterpreterObject:
        return self.get_variable(args, kwargs)

class ModuleObjectHolder(ObjectHolder[ModuleObject]):
    def method_call(self, method_name: str, args: list[TYPE_var], kwargs: TYPE_kwargs) -> TYPE_var:
...
class MutableModuleObjectHolder(ModuleObjectHolder, MutableInterpreterObject):
    def __deepcopy__(self, memo: dict[int, T.Any]) -> MutableModuleObjectHolder:
...
_BuildTarget = T.TypeVar('_BuildTarget', bound=build.BuildTarget | build.BothLibraries)
...
class BuildTargetHolder(ObjectHolder[_BuildTarget]):
    ...
    def private_dir_include_method(self, args: list[TYPE_var], kwargs: TYPE_kwargs) -> build.IncludeDirs:
    ...
    def outdir_method(self, args: list[TYPE_var], kwargs: TYPE_kwargs) -> str:
    ...
    def extract_objects_method(self, args: tuple[list[str | build.TargetSources]], kwargs: TYPE_kwargs) -> build.ExtractedObjects:
    ...
    def vala_header_method(self, args: list[TYPE_var], kwargs: TYPE_kwargs) -> mesonlib.File:
    ...
    def vala_vapi_method(self, args: list[TYPE_var], kwargs: TYPE_kwargs) -> mesonlib.File:
    ...
    def vala_gir_method(self, args: list[TYPE_var], kwargs: TYPE_kwargs) -> mesonlib.File:
...
class BothLibrariesHolder(BuildTargetHolder[build.BothLibraries]):
    ...
    def get_shared_lib_method(self, args: list[TYPE_var], kwargs: TYPE_kwargs) -> build.SharedLibrary:
    ...
    def get_static_lib_method(self, args: list[TYPE_var], kwargs: TYPE_kwargs) -> build.StaticLibrary:
...
class _CustomTargetHolder(ObjectHolder[_CT]):
    ...
    @noKwargs
    @InterpreterObject.method('to_list')
    def to_list_method(self, args: list[TYPE_var], kwargs: TYPE_kwargs) -> list[build.CustomTargetIndex]:
...
class GeneratorHolder(ObjectHolder[build.Generator]):
    ...
    def process_method(self,
                       args: tuple[list[str | build.BuildTarget | build.TargetSources]],
