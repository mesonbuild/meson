...
class Interpreter(InterpreterBase, HoldableObject):
    ...
    def func_declare_dependency(self, node: mparser.BaseNode, args: T.List[TYPE_var],
        ...
        incs = self.extract_incdirs(kwargs, feature_new_version='0.50.0')
    ...
    def extract_incdirs(self, kwargs, key: str = 'include_directories', feature_new_version: T.Optional[str] = None) -> T.List[build.IncludeDirs]:
        prospectives = extract_as_list(kwargs, key)
        if feature_new_version:
            for i in prospectives:
                if isinstance(i, str):
                    FeatureNew.single_use('include_directories kwarg of type string', feature_new_version, self.subproject,
    ...
    def build_target(self, node: mparser.BaseNode, args: T.Tuple[str, SourcesVarargsType],
        ...
        kwargs['include_directories'] = self.extract_incdirs(kwargs, feature_new_version='0.50.0')
