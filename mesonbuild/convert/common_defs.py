...
class ConvertUnimplementedException(MesonException):
    """Exception thrown when a feature on the convert tool is unimplemented"""

    def __init__(self, msg: str, file: T.Optional[str] = None, lineno: T.Optional[int] = None,
                 colno: T.Optional[int] = None):  # fmt: skip
        super().__init__(
            msg + ' not handled yet.  Submit a patch,  exiting...',
            file=file,
            lineno=lineno,
            colno=colno,
        )
