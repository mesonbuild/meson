...
class ConvertInstanceBuildTarget:
    ...
    def __init__(self, build_info: build.Build, build_target: build.BuildTarget,
    ...
    def _parse_build_target(self, build_info: build.Build, build_target: build.BuildTarget,
        ...
        for d in build_target.external_deps:
            if d.found() and isinstance(d, dependency_base.ExternalDependency):
                dep_info = (
                    ...
                    or project_config.dependencies.rust_libraries.get(d.name)
                ...
                dep = ConvertId(
                    target_name, subdir, repo_name, source_url, source_filename, source_hash
                )
    ...
    def _handle_internal_dependencies(self, build_target: build.BuildTarget,
                                      project_config: ConvertProjectConfig) -> None:  # fmt: skip
