...
class ConvertInterpreter(interpreter.Interpreter):
    ...
    def __init__(self, build_info: Build, project_instance: ConvertProjectInstance,
                 project_config: ConvertProjectConfig, **kwargs: T.Any):  # fmt: skip
    ...
    @noArgsFlattening
    def func_find_program(self, node: mparser.BaseNode, args: T.List[T.Any],
                          kwargs: T.Dict[str, T.Any]) -> programs.ExternalProgram:  # fmt: skip
        prog_names = args[0]
    ...
    def run_command_impl(self, args: T.Tuple[T.Union[Executable, programs.Program, Compiler, File, str, T.List[T.Any]],
                                             T.List[T.Union[Executable, programs.Program, Compiler, File, str]]],
                         kwargs: "kwargs.RunCommand",
                         in_builddir: bool = False) -> RunProcess:  # fmt: skip
    ...
    def func_dependency(self, node: mparser.BaseNode, args: T.List[T.Any],
                        kwargs: T.Dict[str, T.Any]) -> dependency_base.Dependency:  # fmt: skip
