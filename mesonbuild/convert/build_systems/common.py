...
class ConvertBackend:
    ...
    def get_label(self, platform: PrecomputedPlatformInfo,
    ...
    def add_build_target_config(self, target: ConvertBuildTarget,
                                instance: T.Union[ConvertInstanceStaticLibrary,
                                                  ConvertInstanceSharedLibrary],
                                platform: PrecomputedPlatformInfo,
                                custom_instances: T.Set[SelectInstance]) -> None:  # fmt: skip
        raise NotImplementedError
...
class ConvertStateTracker:
    ...
    def __init__(self, project_config: ConvertProjectConfig, backend: ConvertBackend):
        ...
        self.current_platform: T.Optional[PrecomputedPlatformInfo] = None
        self.current_custom_select_instances: T.Optional[T.Set[SelectInstance]] = None
        self.all_platforms: T.Set[PrecomputedPlatformInfo] = set()
        self.output_dir: str = ''
        self.project_dir: str = ''
        self.backend = backend
        self.targets = ConvertTree()

    def set_current_config(self, platform_info: PrecomputedPlatformInfo,
