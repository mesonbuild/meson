...
class ConvertAttr(Enum):
    ...
    SOONG_HEADER_LIBS = 105
    SOONG_STATIC_LIBRARIES = 106
    SOONG_SHARED_LIBRARIES = 107
    SOONG_WHOLE_STATIC_LIBRARIES = 108
    SOONG_CFLAGS = 109
    SOONG_CPPFLAGS = 111
    SOONG_C_STD = 112
    SOONG_CPP_STD = 113
    SOONG_RUST_LIBS = 114
    SOONG_LINKER_VERSION_SCRIPT = 115
    SOONG_PYTHON_LIBS = 116
