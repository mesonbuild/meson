...
def define_meson_platform(name, cpu, target_system_name, tool_paths, sysroot_repo, sysroot_path):
    workspace_name = Label(sysroot_repo + "//:all").workspace_name
    full_sysroot_path = "external/" + workspace_name + "/" + sysroot_path
    ...
    cc_toolchain_config(
        ...
        builtin_sysroot = full_sysroot_path,
        cxx_builtin_include_directories = [
            ".",
            full_sysroot_path + "/include",
        ],
        compile_flags = [
            "-target",
            target_system_name,
