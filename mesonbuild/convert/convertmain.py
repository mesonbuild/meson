...
def convert_build_system(
    ...
    This tool operates by parsing three main TOML configuration files:
       ...
       - toolchain.toml: toolchains + sysroots for a hermetic project
    ...
    For each configuration, it simulates a Meson build environment using an "abstract" toolchain
    ...
    for project_instance in project_config.get_project_instances():
        ...
        default_options.cmd_line_options = (
            project_instance.option_instance.meson_options
        )
        ...
        with tempfile.TemporaryDirectory() as build_dir:
            ...
            state_tracker.set_current_config(
                toolchain.toolchain_info, custom_select_instances
            )
            generate(
                project_instance,
                default_options,
