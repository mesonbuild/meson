...
class ConvertProjectInstance:
    ...
    def __init__(self, name: str, host_platform: str, build_platform: str,
        ...
        self.rust_bindgens: T.Dict[str, ConvertInstanceRustBindgen] = {}
    ...
    def normalize_string(self, input_string: str,
                         current_subdir: str) -> str:  # fmt: skip
    ...
    def add_rust_bindgen(self, bindgen: ConvertInstanceRustBindgen) -> None:
        self.rust_bindgens[bindgen.target_name] = bindgen
