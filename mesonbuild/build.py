...
from .mesonlib import (
    ...
    MesonBugException, EnvironmentVariables, pickle_load, add_lists
)
...
if T.TYPE_CHECKING:
    from ._typing import ImmutableListProtocol, ImmutableDictProtocol, ListOrSingle, SequenceOrSingle
    ...
    ObjectTypes = T.Union[str, 'File', 'ExtractedObjects']
...
class DepManifest:
    ...
    def to_json(self) -> T.Dict[str, ListOrSingle[str]]:
        return {
...
class ExtractedObjects(HoldableObject):
    ...
    @staticmethod
    def get_sources(_sources: T.List[File], generated_sources: T.Sequence[GeneratedTypes]) -> T.List[FileOrString]:
        # Merge sources and generated sources
        sources: T.List[FileOrString] = list(_sources)
    ...
    def classify_all_sources(self, sources: T.List[File], generated_sources: T.Sequence[GeneratedTypes]) -> T.Dict[Compiler, T.List[FileOrString]]:
...
class Target(HoldableObject, metaclass=abc.ABCMeta):
    ...
    def get_install_dir(self) -> T.Tuple[T.List[T.Union[str, bool]], T.List[str], bool]:
...
class BuildTarget(Target):
    ...
    def check_unknown_kwargs(self, kwargs: T.Dict[str, T.Any]) -> None:
        # Override this method in derived classes that have more
        # keywords.
        self.check_unknown_kwargs_int(kwargs, self.known_kwargs)

    def check_unknown_kwargs_int(self, kwargs: T.Dict[str, T.Any], known_kwargs: T.Set[str]) -> None:
        unknowns = []
        for k in kwargs:
    ...
    def get_original_kwargs(self) -> T.Dict[str, T.Any]:
        return self.kwargs

    def copy_kwargs(self, kwargs: T.Dict[str, T.Any]) -> None:
    ...
    def extract_objects(self, srclist: T.List[T.Union[str, File, GeneratedTypes]]) -> ExtractedObjects:
    ...
    def get_sources(self) -> ImmutableListProtocol[File]:
        return self.sources
    ...
    def add_deps(self, deps: T.List[dependencies.Dependency]) -> None:
        ...
        for dep in deps:
            ...
            if isinstance(dep, dependencies.InternalDependency):
                ...
                dep_sources: ImmutableListProtocol[T.Union[File, CustomTarget, StructuredSources]] = dep.sources
                self.process_sourcelist(dep_sources)
...
class GeneratedList(HoldableObject):
    ...
    def __post_init__(self) -> None:
        ...
        self.depends: T.Set[T.Union[GeneratedTypes, CompileTarget]] = set()
...
class SharedLibrary(BuildTarget):
    ...
    def get_link_deps_mapping(self, prefix: str) -> ImmutableDictProtocol[str, str]:
        ...
        if old not in mappings:
            ...
            assert isinstance(outdirs[0], str), "You hit a known issue in meson, see https://github.com/mesonbuild/meson/issues/11748"
    ...
    def determine_filenames(self) -> None:
        ...
        # For all other targets/platforms import_filename stays None
            ...
            if self.uses_rust():
                ...
                assert isinstance(debug_option, bool), "for mypy"
    ...
    @staticmethod
    def _validate_darwin_versions(_darwin_versions: ListOrSingle[T.Union[int, str]]) -> T.List[str]:
        try:
            darwin_versions = T.cast('ListOrSingle[T.Any]', _darwin_versions)
            ...
            if isinstance(darwin_versions, str):
                ...
                # darwin_versions = T.cast('T.List[T.Union[int, str]]', 2 * [darwin_versions])
...
class CustomTarget(Target, CommandBase):
    ...
    def __init__(self,
                 ...
                 sources: T.Sequence[T.Union[ObjectTypes, BuildTargetTypes, GeneratedList]],
                 outputs: T.List[str],
                 *,
                 build_always_stale: bool = False,
        ...
        self.sources: ImmutableListProtocol[T.Union[ObjectTypes, BuildTargetTypes, GeneratedList]] = list(sources)
        self.outputs = substitute_values(
            outputs, get_filenames_templates_dict(
                get_sources_string_names(self.sources, backend),
                []))
    ...
    def get_target_dependencies(self) -> T.List[T.Union[Target, ObjectTypes, GeneratedTypes, StructuredSources, programs.ExternalProgram]]:
        deps: T.Sequence[T.Union[Target, ObjectTypes, GeneratedTypes, StructuredSources, programs.ExternalProgram]] = []
        deps = []
    ...
    def get_sources(self) -> ImmutableListProtocol[T.Union[ObjectTypes, BuildTargetTypes, GeneratedList]]:
        return self.sources
...
def get_sources_string_names(sources: ImmutableListProtocol[T.Union[ObjectTypes, BuildTargetTypes, GeneratedList]], backend: Backend) -> T.List[str]:
    '''
