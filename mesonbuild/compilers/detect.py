...
def _get_compilers(env: 'Environment', lang: str, for_machine: MachineChoice,
                   allow_build_machine: bool = False) -> T.Tuple[T.List[T.List[str]], T.List[str], T.Optional['ExternalProgram']]:
    '''
...
def detect_nasm_compiler(env: 'Environment', for_machine: MachineChoice) -> Compiler:
    ...
    compilers, _, _ = _get_compilers(env, 'nasm', for_machine, allow_build_machine=True)
