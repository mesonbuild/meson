...
base_options: 'KeyedOptionDictType' = {
    ...
    OptionKey('b_lto_mode'): coredata.UserComboOption('Select between different LTO modes.', 'default',
                                                      ['default', 'thin']),
    ...
    OptionKey('b_sanitize'): coredata.UserComboOption('Code sanitizer to use', 'none',
    ...
    OptionKey('b_pgo'): coredata.UserComboOption('Use profile guided optimization', 'off',
                                                 ['off', 'generate', 'use']),
    OptionKey('b_coverage'): coredata.UserBooleanOption('Enable coverage tracking.', False),
    OptionKey('b_colorout'): coredata.UserComboOption('Use colored output', 'always',
                                                      ['auto', 'always', 'never']),
    OptionKey('b_ndebug'): coredata.UserComboOption('Disable asserts', 'false', ['true', 'false', 'if-release']),
    ...
    OptionKey('b_vscrt'): coredata.UserComboOption('VS run-time library type to use.', 'from_buildtype',
