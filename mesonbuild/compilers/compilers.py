...
class Compiler(HoldableObject, metaclass=abc.ABCMeta):
    ...
    def sanity_check(self, work_dir: str) -> None:
        ...
        if transpiled:
            cmdlist = self._sanity_check_compile_args(sourcename, transpiled)
            ...
            cmdlist = self._transpiled_sanity_check_compile_args(comp, transpiled, binname)

            mlog.debug('checking compilation of transpiled source:')
        else:
            cmdlist = self._sanity_check_compile_args(sourcename, binname)
    ...
    def _transpiled_sanity_check_compile_args(
            self, compiler: Compiler, sourcename: str, binname: str) -> T.List[str]:
