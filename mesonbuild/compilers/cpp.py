...
class ClangCPPCompiler(_StdCPPLibMixin, ClangCPPStds, ClangCompiler, CPPCompiler):
    ...
    def get_option_compile_args(self, target: 'BuildTarget', env: 'Environment', subproject: T.Optional[str] = None) -> T.List[str]:
        ...
        rtti = env.coredata.optstore.get_target_or_global_option(target, self.form_compileropt_key('rtti'), bool)
        debugstl = env.coredata.optstore.get_target_or_global_option(target, self.form_compileropt_key('debugstl'), bool)
