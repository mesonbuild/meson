...
class Backend:
    ...
    def as_meson_exe_cmdline(self, exe: T.Union[str, mesonlib.File, build.BuildTarget, build.CustomTarget, build.CustomTargetIndex, programs.Program],
                             cmd_args: T.Sequence[T.Union[str, mesonlib.File, build.BuildTarget, build.CustomTarget, build.CustomTargetIndex, programs.Program]],
                             workdir: T.Optional[str] = None,
                             extra_bdeps: T.Optional[T.List[build.BuildTarget]] = None,
                             capture: T.Optional[str] = None,
                             feed: T.Optional[str] = None,
        ...
        '''
        cmd: T.List[T.Union[str, mesonlib.File, build.BuildTarget, build.CustomTarget, build.CustomTargetIndex, programs.Program]] = []
        cmd.append(exe)
        cmd.extend(cmd_args)
    ...
    def build_target_to_cmd_array(self, bt: T.Union[build.BuildTarget, build.CustomTarget, build.CustomTargetIndex, programs.Program]) -> T.List[str]:
    ...
    def get_custom_target_sources(self, target: build.CustomTarget) -> T.List[str]:
        ...
        for i in target.get_sources():
            ...
            if isinstance(i, str):
                ...
                assert isinstance(i, programs.ExternalProgram)
