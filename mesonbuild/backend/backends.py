...
class Backend:
    ...
    def get_target_dir(self, target: T.Union[build.Target, build.CustomTargetIndex]) -> str:
        if isinstance(target, build.RunTarget):
            ...
            dirname = ''
        elif self.environment.coredata.optstore.get_value_for_safe(OptionKey('layout'), str) == 'mirror':
    ...
    def generate_depmf_install(self, d: InstallData) -> None:
        ...
        if depmf_path is None:
            option_dir = self.environment.coredata.optstore.get_value_for_safe(OptionKey('licensedir'), str)
            if option_dir:
    ...
    def guess_install_tag(self, fname: str, outdir: T.Optional[str] = None) -> T.Optional[str]:
        ...
        _ldir = self.environment.coredata.optstore.get_value_for_safe(OptionKey('localedir'), str)
