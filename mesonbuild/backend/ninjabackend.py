...
''')
    ...
    def generate_target(self, target, outfile):
        ...
        for src in vala_generated_source_files:
            # Passing 'is_generated=True' here signifies that we want the
            # compile arguments to be specialized for C code generated by
            # valac. For instance, no warnings should be emitted for
            # 'warning_level' 1.
...
'''
    ...
    def _generate_single_compile(self, target, compiler, is_generated=False):
        ...
        commands += self.generate_basic_compiler_args(target, compiler, is_generated)
