...
class NinjaBackend(backends.Backend):
    ...
    def detect_vs_dep_prefix(self, tempfilename: str) -> T.TextIO:
        ...
        extra_args = T.cast('T.List[str]', self.environment.coredata.optstore.get_value_for_untyped(
...
''')
    ...
    def generate_cython_transpile(self, target: build.BuildTarget) -> \
        ...
        cython_args = self.environment.coredata.optstore.get_value_for_untyped(
