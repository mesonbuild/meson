...
if T.TYPE_CHECKING:
    ...
    class CheckPlatformsOptions(Protocol):
        name: T.Optional[str]
        output: T.Optional[str]
        cross_file: T.Optional[str]
        android_ndk_version: T.Optional[str]
        android_ndk_platform: str
        fuchsia_clang_instance_id: T.Optional[str]
        fuchsia_core_sdk_instance_id: T.Optional[str]
...
def run(options: CheckPlatformsOptions) -> int:
