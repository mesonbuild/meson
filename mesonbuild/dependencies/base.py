...
class ConfigToolDependency(ExternalDependency):
    ...
    def get_variable(self, *, cmake: typing.Optional[str] = None, pkgconfig: typing.Optional[str] = None,
        ...
        if configtool:
            try:
                # in the not required case this will be '' (empty string) if
                # the variable is not found, in that case we want to continue
                # and not return ''
                v = self.get_configtool_variable(configtool)
                if v:
                    return v
