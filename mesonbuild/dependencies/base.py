...
if T.TYPE_CHECKING:
    ...
    from ..build import (
        ...
        StaticLibrary, ExtractedObjects, GeneratedTypes
    )
...
class Dependency(HoldableObject):
    ...
    def __init__(self, kwargs: DependencyObjectKWs) -> None:
        ...
        self.sources: T.List[T.Union[mesonlib.File, GeneratedTypes]] = []
    ...
    def get_sources(self) -> T.List[T.Union[mesonlib.File, GeneratedTypes]]:
...
class InternalDependency(Dependency):
    ...
    def __init__(self, version: str, incdirs: T.Optional[T.List['IncludeDirs']] = None,
                 ...
                 sources: T.Optional[T.Sequence[T.Union[mesonlib.File, GeneratedTypes]]] = None,
