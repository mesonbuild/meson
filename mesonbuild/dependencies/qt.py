...
class QtExtraFrameworkDependency(ExtraFrameworkDependency):
    def __init__(self, name: str, env: 'Environment', kwargs: DependencyKWs, qvars: T.Dict[str, str], language: T.Optional[str] = None):
...
class _QtBase:
    ...
    def __init__(self, name: str, kwargs: DependencyKWs):
        self.name = name
...
class QmakeQtDependency(_QtBase, ConfigToolDependency, metaclass=abc.ABCMeta):
    ...
    def _framework_detect(self, qvars: T.Dict[str, str], modules: T.List[str], kwargs: DependencyKWs) -> None:
        libdir = qvars['QT_INSTALL_LIBS']
