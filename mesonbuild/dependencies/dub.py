...
class DubDependency(ExternalDependency):
    ...
    def __init__(self, name: str, environment: 'Environment', kwargs: T.Dict[str, T.Any]):
        ...
        dub_fetch_build = bool(environment.coredata.get_option(OptionKey('dub_fetch_build')))
        ...
        if ret != 0 and dub_fetch_build and 'locally' in err:
        ...
        def find_target_and_build_if_needed(pkg: T.Dict[str, str]) -> bool:
            ...
            if tgt_file is None and dub_fetch_build and dub_build_package(pack_id, pkg['configuration']):
                tgt_file = self._find_dub_build_target(description, pkg, comp_id)
            if tgt_file is None:
