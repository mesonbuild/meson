...
def add_arguments(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument('-t', '--timeout-multiplier', type=float, default=None, metavar='N',
                        help='Define a multiplier for test time limit. For example '
                        ' when tests in particular conditions are N times slower'
                        ' (<= 0 to disable timeout)')
    parser.add_argument('--setup', default=None, dest='setup',
                        help='Which test setup to use')
    parser.add_argument('--test-args', default=[], type=split_args, metavar='ARGS',
                        help='Arguments to pass to executed tests')
