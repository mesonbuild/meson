...
class DataTests(unittest.TestCase):
    ...
    def test_builtin_options_documented(self):
        ...
        for m in rows:
            ...
            self.assertEqual(env.coredata.optstore.get_value('buildtype', str), buildtype)
            self.assertEqual(env.coredata.optstore.get_value('optimization', str), opt)
            self.assertEqual(env.coredata.optstore.get_value('debug', bool), debug)
