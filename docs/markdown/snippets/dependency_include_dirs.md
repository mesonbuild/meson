...
Prior to 1.2.0, dependencies declared with `declare_dependency` would separate
...
implementation more complicated. As of 1.2.0 this has been changed to separate
