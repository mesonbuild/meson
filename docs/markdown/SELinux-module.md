...
Example:
```meson
selinux.package('mydaemon')
```

This will look for `mydaemon.te`, `mydaemon.if`, and `mydaemon.fc` in the
current subdirectory and build a policy package named `mydaemon.pp`.
...
- `package_name` (string): The base name for your policy. This is used to
  determine the default names of input files and the final output file (e.g.,
  `mydaemon` results in `mydaemon.pp`).

#### Keyword Arguments

| Name            | Type            | Default Value                      | Description                                                                                                     |
|-----------------|-----------------|------------------------------------|-----------------------------------------------------------------------------------------------------------------|
| `te_file`       | `str` or `file` | `'{package_name}.te'`              | The main Type Enforcement file for the policy.                                                                  |
