...
| b_pie               | auto                 | enabled, auto, disabled; *deprecated*: true, false            | Build position-independent executables (`true` and `false` accepted since 0.49.0; current possible values valid since 1.4.0) |
