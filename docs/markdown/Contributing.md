...
Meson uses Flake8 and Ruff for style guide enforcement. The Flake8 options for
the project are contained in .flake8, the ruff options are in pyproject.toml
