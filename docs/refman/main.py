...
from .generatortypes import GeneratorTypes
...
def main() -> int:
    ...
    parser.add_argument('-g', '--generator', type=str, choices=['print', 'pickle', 'md', 'json', 'man', 'types'], required=True, help='Generator backend')
    ...
    generators: T.Dict[str, T.Callable[[], GeneratorBase]] = {
        ...
        'types': lambda: GeneratorTypes(refMan, args.out, not args.no_modules),
    }
